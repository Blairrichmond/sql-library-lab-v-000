...
def select_name_and_series_subgenres_of_authors
  "SELECT authors.name, subgenres.name FROM authors LEFT JOIN series ON authors.id = series.author_id LEFT JOIN series ON subgenres.id = series.subgenre_id GROUP BY author.name, subgenres.name;"
end
